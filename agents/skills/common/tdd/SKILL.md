---
name: tdd
description: "Use when the user explicitly asks for TDD, a failing test, or a regression test, or when the bug has an obvious cheap local test target. Skip when the test path is unclear, expensive, or integration-heavy."
---
