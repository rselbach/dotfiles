...
Locate transcripts through the current harness and keep searches inside the active workspace. If the harness does not expose transcripts, reconstruct context from handoff notes, branches, PRs, tickets, and live state.
