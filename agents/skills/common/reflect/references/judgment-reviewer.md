...
- Reads of any `SKILL.md` under the project or user skill roots exposed by the current harness
- Delegated prompts that name a skill path
- File searches, read-only commands, or MCP calls that match a skill's documented commands
