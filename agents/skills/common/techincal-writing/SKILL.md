...
description: "Layered technical-writing standard: Diátaxis structure, Google developer style sentences, STE instruction rules, Global English syntax. Use for the `technical-writing` skill or when writing or reviewing docs, RFCs, readmes, PR descriptions, or commit messages."
