...
A subagent that opens a PR runs `interrogate`, the available diff-cleanup workflow, and `/no-comments`. It returns the URL and does not babysit. Return to the parent.
