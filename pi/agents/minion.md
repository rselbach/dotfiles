...
Follow the repository's AGENTS.md conventions: respect the style guide, run the appropriate typecheck, lint, build, and test commands after code changes, and stay within the scope of the task.
